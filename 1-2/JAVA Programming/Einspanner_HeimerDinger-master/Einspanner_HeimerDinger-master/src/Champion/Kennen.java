...
public class Kennen extends EnergyCost_Champ {
    Kennen() {
        super.name = "케넨";
        super.level = 1;
        super.range = 550;
    ...
    public void skill_Q() {
        ...
        System.out.println("재사용 대기시간: 8/7/6/5/4초\n");
    }
    ...
    public void skill_W() {
        ...
        System.out.println("재사용 대기시간: 14/12/10/8/6초\n");
    }
    ...
    public void skill_E() {
        ...
        System.out.println("재사용 대기시간: 10/9/8/7/6초\n");
    }
    ...
    public void skill_R() {
        ...
        System.out.println("범위: " + range);
        System.out.println("기력 소모: " + use_Cost);
        System.out.println("재사용 대기시간: " + coolDown + "초\n");
    }
}
